...
class LightGCN(BasicModel):
    ...
    def get_feature_extra(self):
        #load_feature
        print("load_feature...")
        d_feat_extra = np.zeros((self.num_users,2159),dtype=float)
        f_feat_extra = np.zeros((self.num_items,2159),dtype=float)
        with open('../data/drugbank-DFI/feature_extra/drug_feature_extra.txt','r') as f1:
            i = 0
            for line in f1.readlines():
                ...
                for item in feature:
                    ...
                    j +=1
                i +=1
        with open('../data/drugbank-DFI/feature_extra/food_feature_extra.txt','r') as f2:
            i = 0
        ...
        d_feat_extra = torch.Tensor(d_feat_extra).to(world.device)
        f_feat_extra = torch.Tensor(f_feat_extra).to(world.device)
